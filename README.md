...
Atualmente atuo com projetos que integram **Ciência de Dados, Machine Learning, Inteligência Artificial e Geotecnologias**, aplicando Python, SQL, Google Earth Engine, QGIS, ArcGIS e PostgreSQL/PostGIS para transformar dados ambientais e territoriais em informação estratégica para apoio à tomada de decisão.
...
<img align="left" alt="Plotly" width="35px" src="https://images.plot.ly/logo/new-branding/plotly-logomark.png"/>
<img align="left" alt="Streamlit" width="35px" src="https://streamlit.io/images/brand/streamlit-mark-color.png"/>
...
🔗 Repositório/Demonstração: `adicionar link, se aplicável`
